...
#include "armrobot_msgs/action/armrobot_task.hpp"
...
public:
    ...
    : Node("task_server", options)
  {
    ...
    action_server_ = rclcpp_action::create_server<armrobot_msgs::action::ArmrobotTask>(
...
private:
  rclcpp_action::Server<armrobot_msgs::action::ArmrobotTask>::SharedPtr action_server_;
  ...
  rclcpp_action::GoalResponse goalCallback(
      ...
      std::shared_ptr<const armrobot_msgs::action::ArmrobotTask::Goal> goal)
  {
  ...
  rclcpp_action::CancelResponse cancelCallback(
      const std::shared_ptr<rclcpp_action::ServerGoalHandle<armrobot_msgs::action::ArmrobotTask>> goal_handle)
  {
    (void)goal_handle;
  ...
  void execute(const std::shared_ptr<rclcpp_action::ServerGoalHandle<armrobot_msgs::action::ArmrobotTask>> goal_handle)
  {
    RCLCPP_INFO(get_logger(), "Executing goal");
    auto result = std::make_shared<armrobot_msgs::action::ArmrobotTask::Result>();
...
RCLCPP_COMPONENTS_REGISTER_NODE(armrobot_remote::TaskServer)